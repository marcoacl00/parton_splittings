...
void euler_step(fourD_grid& F_a, fourD_grid& F_b, fourD_grid& RHS_a, fourD_grid& RHS_b, 
const fourD_grid& M_aa, const fourD_grid& M_ab, const fourD_grid& M_ba, const fourD_grid& M_bb, double T){


    compute_rhs(F_a, F_b, M_aa, M_ab, M_ba, M_bb, RHS_a, RHS_b, T);
...
int main(int argc, char* argv[]) { 
    ...
    for (int t = 0; t < 334; t++){
        ...
        euler_step(F_a_sol, F_b_sol, RHSa, RHSb, Maa, Mab, Mba, Mbb, t0 + t*dt);
